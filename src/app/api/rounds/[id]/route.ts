 ...
 * Settles by consensus if the round closed with answers (full, or window
 * passed), or refunds the asker if it closed with zero answers — covers
 * the case where the last answer's own request already tried, or nobody
 * answered at all.
 */
